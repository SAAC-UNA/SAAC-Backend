<?php
/**
 * Script temporal para regenerar ElementAssignmentTestSeeder.php
 * Uso: php database/scripts/gen_ea_seeder.php
 */
...
file_put_contents(
    __DIR__ . '/../seeders/ElementAssignmentTestSeeder.php',
    $seeder
);

echo "ElementAssignmentTestSeeder.php escrito correctamente.\n";
