...
class AccreditationCycleService
{
    ...
    public function getAll(array $filters = [])
    {
        ...
        return AccreditationCycle::with('careerCampus.career', 'careerCampus.campus', 'structureModel')->paginate($perPage);
    }
    ...
    {
        return AccreditationCycle::with('careerCampus.career', 'careerCampus.campus', 'structureModel')->find($id);
    }
    ...
    public function create(array $data): AccreditationCycle
    {
        ...
        return $cycle->load(['careerCampus.career', 'careerCampus.campus', 'structureModel']);
    }
    ...
    public function update(AccreditationCycle $cycle, array $data): AccreditationCycle
    {
        ...
        return $cycle->fresh(['careerCampus.career', 'careerCampus.campus', 'structureModel']);
    }
