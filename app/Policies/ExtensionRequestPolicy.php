...
class ExtensionRequestPolicy
{
     ...
     * - Admin actualiza datos por excepción
     * 
     * RESTRICCIONES:
     * - Solo solicitudes en estado PENDIENTE
     * - Solo el creador (excepto admins)
     * 
     * @param User $user Usuario autenticado
    ...
    public function update(User $user, ExtensionRequest $extensionRequest): bool
    {
        ...
        // Solo el creador puede editar su solicitud (o admin/superusuario)
        return $extensionRequest->usuario_id === $user->usuario_id || 
               $user->hasRole(['Administrador', 'Superusuario']);
    }
     ...
     * - Admin elimina solicitud por error/duplicado
     * 
     * RESTRICCIONES:
    ...
    public function delete(User $user, ExtensionRequest $extensionRequest): bool
    {
        ...
        // Solo el creador puede eliminar su solicitud (o admin/superusuario)
        return $extensionRequest->usuario_id === $user->usuario_id || 
               $user->hasRole(['Administrador', 'Superusuario']);
    }
