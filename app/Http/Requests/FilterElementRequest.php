...
class FilterElementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'elemento_raiz_id'      => ['nullable', 'integer', 'exists:ELEMENTO,elemento_id'],
            ...
            'falta_archivo'         => ['nullable', 'boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'padre_id.exists'                  => 'El elemento padre especificado no existe.',            'elemento_raiz_id.integer'           => 'El ID del elemento raíz debe ser un entero.',
            'elemento_raiz_id.exists'            => 'El elemento raíz especificado no existe.',            'fecha_limite_desde.date'          => 'La fecha límite desde debe ser una fecha válida.',
            ...
            'proceso_id.integer'               => 'El ID del proceso debe ser un entero.',
            ...
            'responsable_id.integer'           => 'El ID del responsable debe ser un entero.',
            ...
            'requiere_archivo.boolean'         => 'El campo requiere_archivo debe ser verdadero o falso.',
            'falta_archivo.boolean'            => 'El campo falta_archivo debe ser verdadero o falso.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'elemento_raiz_id'      => 'elemento raíz',
            ...
            'requiere_archivo'      => 'requiere archivo',
